...
export const GUI_TRANSLATION_OVERRIDES: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "appUpdate.announcementClose": "关闭更新公告",
    ...
    "settings.aboutApplication": "应用",
    "settings.aboutApplicationDesc": "名称、版本与当前更新通道。",
    "settings.aboutSoftwareUpdate": "软件更新",
    "settings.aboutSoftwareUpdateDesc": "检查、安装桌面端更新并查看发布说明。",
    ...
    "settings.aboutOpenAnnouncement": "查看公告",
    ...
    "settings.aboutCheckingDesc": "正在检查当前更新通道。",
    ...
    "settings.aboutUpdateAvailableDesc": "新版本已经可以安装。",
    "settings.aboutUpToDate": "已是最新版本",
    "settings.aboutUpToDateDesc": "当前通道没有可用更新。",
    "settings.aboutManualUpdate": "发现新版本（需手动更新）",
    "settings.aboutManualUpdateDesc": "请打开发布页下载并手动安装新版本。",
    "settings.aboutUpdaterNotConfigured": "更新未配置",
    "settings.aboutUpdaterNotConfiguredDesc": "当前构建不支持自动更新。",
    ...
    "settings.aboutChannelStable": "稳定通道",
    "settings.aboutChannelPrerelease": "预发布通道",
    "settings.aboutPrereleaseTitle": "接收预发布版本",
    "settings.aboutPrereleaseToggle": "接收预发布版本",
    "settings.aboutPrereleaseDesc": "开启后也会检查 beta、rc 等预发布版本。",
    ...
    "settings.defaultCloseWindowBehavior": "点击关闭按钮时",
    ...
    "settings.backupScopeSummaryTitle": "备份内容",
    "settings.backupScopeSummary":
      "包含服务商、MCP 与系统偏好等配置；不包含对话、文件、密钥和设备数据。",
    "settings.backupScopeView": "查看详情",
    ...
    "settings.backupSyncConfigure": "设置同步",
    "settings.backupSyncManage": "管理",
    ...
    "settings.globalShortcutsDesc":
      "点击快捷键录制，Enter 保存，Esc 取消。全局快捷键在其他应用中也可用，应用快捷键仅在当前窗口生效。",
  ...
  "en-US": {
    ...
    "appUpdate.announcementClose": "Close update announcement",
    ...
    "settings.aboutApplication": "Application",
    "settings.aboutApplicationDesc": "Name, version, and current update channel.",
    "settings.aboutSoftwareUpdate": "Software Update",
    "settings.aboutSoftwareUpdateDesc": "Check and install desktop updates or view release notes.",
    ...
    "settings.aboutOpenAnnouncement": "View Announcement",
    "settings.aboutAnnouncementUnavailable": "No update announcement",
    ...
    "settings.aboutCheckingDesc": "Checking the current update channel.",
    ...
    "settings.aboutUpdateAvailableDesc": "The new version is ready to install.",
    "settings.aboutUpToDate": "Up to date",
    "settings.aboutUpToDateDesc": "No update is available in the current channel.",
    "settings.aboutManualUpdate": "New version available (manual update)",
    "settings.aboutManualUpdateDesc": "Open the release page to download and install it manually.",
    "settings.aboutUpdaterNotConfigured": "Updater not configured",
    "settings.aboutUpdaterNotConfiguredDesc": "This build does not support automatic updates.",
    ...
    "settings.aboutChannelStable": "Stable channel",
    "settings.aboutChannelPrerelease": "Pre-release channel",
    "settings.aboutPrereleaseTitle": "Receive Pre-releases",
    "settings.aboutPrereleaseToggle": "Receive pre-release versions",
    "settings.aboutPrereleaseDesc": "Also check beta, rc, and other pre-release versions.",
    "settings.systemProxyDesc":
    ...
    "settings.defaultCloseWindowBehavior": "When clicking the close button",
    ...
    "settings.backupScopeSummaryTitle": "Backup contents",
    "settings.backupScopeSummary":
      "Includes providers, MCP, and system preferences; excludes chats, files, keys, and device data.",
    "settings.backupScopeView": "View details",
    ...
    "settings.backupSyncConfigure": "Set Up Sync",
    "settings.backupSyncManage": "Manage",
    ...
    "settings.globalShortcutsDesc":
      "Click a shortcut to record. Enter saves; Esc cancels. Global shortcuts also work in other apps; App shortcuts work while this window is focused.",
