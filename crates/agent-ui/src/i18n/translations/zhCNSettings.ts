export const ZH_CN_SETTINGS_TRANSLATIONS = {
  ...
  "git.branchSelector.switchConfirmAction": "切换分支",
  "git.branchSelector.treeView": "目录视图",
  "settings.modelAllProviders": "全部供应商",
  "settings.modelBadgeReasoning": "推理",
  "settings.modelBadgeVision": "视觉",
  "settings.navMcp": "MCP",
  ...
  "settings.memoryBrowseDescription": "管理跨对话保留的信息、项目知识与日记。",
  ...
  "settings.systemProxyDialogDesc": "配置代理地址与端口，修改会自动保存。",
  "settings.systemProxyScope": "生效范围",
  "settings.backupSyncChooseProvider": "选择 WebDAV 服务商",
  "settings.backupSyncBackToProviders": "返回选择服务商",
  "settings.remoteHideToken": "隐藏令牌",
  "settings.remoteShowToken": "显示令牌",
  "settings.remotePortLabel": "端口",
  "settings.remoteSetupHint": "填写网关地址与访问令牌，完成远程连接配置。",
  "settings.remoteConfigure": "配置",
  "settings.remoteOptionsTitle": "访问与连接选项",
  "settings.remoteOptionsHint": "管理自动重连、心跳，以及远程终端等功能。",
  "settings.remoteConfigHint": "修改会自动保存。",
  "settings.remoteDone": "完成",
  ...
  "settings.fontFamilySearchPlaceholder": "搜索字体…",
  "settings.fontFamilyNoResults": "没有匹配的字体",
  "settings.executionMode": "执行模式",
  "settings.defaultExecutionMode": "默认模式",
  ...
  "settings.systemToolsSearch": "搜索工具名称、ID 或说明…",
  "settings.systemToolsFilter": "筛选工具",
  "settings.systemToolsAll": "全部工具",
  "settings.systemToolsConfigurable": "可配置",
  "settings.systemToolsEmpty": "没有匹配的工具",
  "settings.systemToolsClear": "清除筛选",
  "settings.systemToolsAlwaysAllowed": "只读 · 始终允许",
  ...
  "settings.providerModelApply": "应用",
  "settings.selectModelToEdit": "选择一个模型查看和编辑能力、上下文与输出限制。",
  "settings.providerGlobalPreferences": "通用偏好",
  "settings.providerProtocolPreferences": "协议故障转移",
  "settings.providerSettingsAutosave":
    "修改自动保存；通用偏好对所有服务生效，故障转移按兼容协议配置。",
  "settings.providerChooseService": "选择服务类型",
  "settings.providerChooseServiceHint": "先选择兼容协议，下一步填写连接信息并配置模型。",
  "settings.providerServices": "服务",
  "settings.providerProtocolTools": "导入与协议设置",
  "settings.providerServiceType": "服务类型",
  "settings.providerServiceTypeHint": "按服务支持的 API 选择兼容类型。切换类型会保留已填写的内容。",
  "settings.providerAdvancedSettings": "高级设置",
  "settings.providerAdvancedDraftHint": "此处修改将在保存供应商时一起保存。",
  ...
  "settings.cronExecutionOptions": "执行选项",
  "settings.cronSchedulePreset": "常用计划",
  "settings.cronScheduleCustom": "自定义表达式",
  "settings.cronScheduleHourly": "每小时整点",
  "settings.cronScheduleDaily": "每天 09:00",
  "settings.cronScheduleWeekdays": "工作日 09:00",
  "settings.cronChooseType": "选择任务类型",
  ...
  "settings.skillsAgentModeRequired": "Skills 需要 Agent 模式",
  "settings.skillsAgentModeExplanation":
    "当前为 Chat 模式，技能暂不可用。切换到 Agent 模式后即可管理和使用技能，已有配置会保留。",
  ...
  "settings.skillsStoreSortLabel": "技能商店排序",
  ...
  "settings.cuaDriver.enablePreview":
    "启用后，AI 可以按审批策略识别屏幕内容并操作桌面。你可以随时关闭。",
  "settings.cuaDriver.installFirst": "完成驱动安装后，即可进行此步骤。",
  "settings.cuaDriver.permissionsFirst": "完成系统授权后，即可启用。",
  "settings.cuaDriver.setupTitle": "开始使用",
  "settings.cuaDriver.setupInstall": "安装驱动",
  "settings.cuaDriver.setupPermissions": "系统授权",
  "settings.cuaDriver.setupEnable": "启用",
  "settings.cuaDriver.setupInstallDesc":
    "先安装桌面操作驱动，再完成系统授权，最后启用 Computer Use。",
  "settings.cuaDriver.setupPermissionsDesc":
    "驱动已安装。下一步检查系统权限，允许识别屏幕内容和操作桌面。",
  "settings.cuaDriver.setupReadyDesc":
    "准备工作已完成。启用后，AI 可以按审批策略使用桌面操作工具。",
  "settings.cuaDriver.setupContinue": "检查并完成授权",
  "settings.cuaDriver.setupDialogDesc": "安装驱动 → 系统授权 → 启用。完成当前步骤后继续下一步。",
  "settings.cuaDriver.manageTitle": "管理设置",
  "settings.cuaDriver.manageDesc": "查看驱动信息，调整审批策略与运行参数。",
  "settings.cuaDriver.manageAction": "管理",
  "settings.cuaDriver.close": "完成",
