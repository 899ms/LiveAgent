export const EN_US_SETTINGS_TRANSLATIONS = {
  ...
  "git.branchSelector.switchConfirmAction": "Switch branch",
  "git.branchSelector.treeView": "Tree view",
  "settings.modelAllProviders": "All providers",
  "settings.modelBadgeReasoning": "Reasoning",
  "settings.modelBadgeVision": "Vision",
  "settings.navMcp": "MCP",
  ...
  "settings.memoryBrowseDescription":
    "Manage information kept across conversations, project knowledge, and journals.",
  ...
  "settings.systemProxyDialogDesc":
    "Set the proxy address and port. Changes are saved automatically.",
  "settings.systemProxyScope": "Where this proxy applies",
  "settings.backupSyncChooseProvider": "Choose a WebDAV provider",
  "settings.backupSyncBackToProviders": "Back to providers",
  "settings.remoteHideToken": "Hide token",
  "settings.remoteShowToken": "Show token",
  "settings.remotePortLabel": "Port",
  "settings.remoteSetupHint":
    "Enter the gateway address and access token to set up your connection.",
  "settings.remoteConfigure": "Configure",
  "settings.remoteOptionsTitle": "Access and connection options",
  "settings.remoteOptionsHint": "Manage reconnection, heartbeat, and remote features.",
  "settings.remoteConfigHint": "Changes are saved automatically.",
  "settings.remoteDone": "Done",
  ...
  "settings.fontFamilyNoResults": "No matching fonts",
  "settings.executionMode": "Execution Mode",
  "settings.defaultExecutionMode": "Default Mode",
  ...
  "settings.systemToolsSearch": "Search tool names, IDs or descriptions…",
  "settings.systemToolsFilter": "Filter tools",
  "settings.systemToolsAll": "All tools",
  "settings.systemToolsConfigurable": "Configurable",
  "settings.systemToolsEmpty": "No matching tools",
  "settings.systemToolsClear": "Clear filters",
  "settings.systemToolsAlwaysAllowed": "Read-only · Always allowed",
  ...
  "settings.providerModelApply": "Apply",
  "settings.selectModelToEdit": "Select a model to edit its capabilities and token limits.",
  "settings.providerGlobalPreferences": "General preferences",
  "settings.providerProtocolPreferences": "Protocol failover",
  "settings.providerSettingsAutosave":
    "Changes save automatically. General preferences apply to all services; failover is configured per protocol.",
  "settings.providerChooseService": "Choose a service type",
  "settings.providerChooseServiceHint":
    "Select the compatible API, then configure the connection and models.",
  "settings.providerServices": "Services",
  "settings.providerProtocolTools": "Import and protocol settings",
  "settings.providerServiceType": "Service type",
  "settings.providerServiceTypeHint":
    "Choose the API supported by your service. Switching types keeps your draft.",
  "settings.providerAdvancedSettings": "Advanced settings",
  "settings.providerAdvancedDraftHint": "Changes are saved together when you save the provider.",
  ...
  "settings.cronExecutionOptions": "Execution options",
  "settings.cronSchedulePreset": "Schedule presets",
  "settings.cronScheduleCustom": "Custom expression",
  "settings.cronScheduleHourly": "Every hour",
  "settings.cronScheduleDaily": "Daily at 09:00",
  "settings.cronScheduleWeekdays": "Weekdays at 09:00",
  "settings.cronChooseType": "Choose task type",
  ...
  "settings.skillsAgentModeRequired": "Skills require Agent mode",
  "settings.skillsAgentModeExplanation":
    "You are in Chat mode, where skills are unavailable. Switch to Agent mode to manage and use skills. Your existing configuration will be kept.",
  ...
  "settings.skillsStoreSortLabel": "Sort store skills",
  ...
  "settings.cuaDriver.enablePreview":
    "Once enabled, AI can read the screen and control the desktop under your approval policy. You can turn it off at any time.",
  "settings.cuaDriver.installFirst": "Install the driver before completing this step.",
  "settings.cuaDriver.permissionsFirst": "Grant system permissions before enabling.",
  "settings.cuaDriver.setupTitle": "Get started",
  "settings.cuaDriver.setupInstall": "Install driver",
  "settings.cuaDriver.setupPermissions": "Permissions",
  "settings.cuaDriver.setupEnable": "Enable",
  "settings.cuaDriver.setupInstallDesc":
    "Install the desktop driver, grant system permissions, then enable Computer Use.",
  "settings.cuaDriver.setupPermissionsDesc":
    "The driver is installed. Check system permissions to read the screen and control the desktop.",
  "settings.cuaDriver.setupReadyDesc":
    "Setup is complete. Enable desktop tools to use them under your approval policy.",
  "settings.cuaDriver.setupContinue": "Review permissions",
  "settings.cuaDriver.setupDialogDesc":
    "Install driver → Grant permissions → Enable. Complete each step to continue.",
  "settings.cuaDriver.manageTitle": "Manage settings",
  "settings.cuaDriver.manageDesc": "Review driver details, approval policy, and runtime options.",
  "settings.cuaDriver.manageAction": "Manage",
  "settings.cuaDriver.close": "Done",
