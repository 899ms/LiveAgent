...
import FoldVerticalSource from "~icons/lucide/fold-vertical";
...
import RotateCcwSource from "~icons/lucide/rotate-ccw";
import RotateCwSource from "~icons/lucide/rotate-cw";
...
export const FoldVertical = createIcon(FoldVerticalSource);
...
export const RotateCcw = createIcon(RotateCcwSource);
export const RotateCw = createIcon(RotateCwSource);
